...
import 'actionsheet_selected_list_custom_example.dart';
import 'actionsheet_selected_list_example.dart';
...
class _ActionSheetEntryPageState extends State<ActionSheetEntryPage> {
  ...
  void _showCommonStyle(BuildContext context) {
    List<CommonActionSheetItem> actions = [];
    actions.add(CommonActionSheetItem(
      '选项一（警示项）',
      desc: '辅助信息辅助信息辅助信息',
      actionStyle: CommonActionSheetItemStyle.alert,
    ));
    actions.add(CommonActionSheetItem(
      '选项二',
      desc: '辅助信息辅助信息辅助信息',
      actionStyle: CommonActionSheetItemStyle.normal,
    ));
    actions.add(CommonActionSheetItem(
      '选项三',
      desc: '辅助信息辅助信息辅助信息',
    ...
    showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return CommonActionSheet(
            ...
            actions: actions,
            cancelTitle: "自定义取消名称",
            clickCallBack: (int index, CommonActionSheetItem actionEle) {
              String? title = actionEle.title;
              PhoenixToast.show("title: $title, index: $index", context);
            },
          );
        });
  }
    ...
    showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return CommonActionSheet(
            ...
            clickCallBack: (
              int index,
              CommonActionSheetItem actionEle,
            ) {
              String? title = actionEle.title;
              PhoenixToast.show("title: $title, index: $index", context);
            },
  ...
  void _showCommonStyle2(BuildContext context) {
    ...
    actions.add(CommonActionSheetItem(
      '选项一: （010）1234567',
      actionStyle: CommonActionSheetItemStyle.link,
    ));
    actions.add(CommonActionSheetItem(
      '选项二:（010）1234567',
      actionStyle: CommonActionSheetItemStyle.link,
        ...
        builder: (BuildContext context) {
          return CommonActionSheet(
            ...
            onItemClickInterceptor: (
              ...
              // 选项三点击事件被拦截，不作处理
              if (index == 2) {
                PhoenixToast.show("被拦截了", context);
                return true;
              }
              // 其他选项正常
              return false;
  ...
  void _showShareSevenStyle(BuildContext context) {
    List<ShareItem> firstRowList = [];
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareWeiXin,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareBrowser,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareCopyLink,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareFriend,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
    ...
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareQQ,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareCustom,
      customImage: PhoenixTools.getAssetImage("images/icon_custom_share.png"),
      customTitle: "自定义",
      canClick: true,
    ));
    ShareActionSheet actionSheet = ShareActionSheet(
      firstShareChannels: firstRowList,
      clickCallBack: (int section, int index, ShareItem shareItem) {
  ...
  void _showShareFourStyle(BuildContext context) {
    List<ShareItem> firstRowList = [];
    List<ShareItem> secondRowList = [];
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareQZone,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareSaveImage,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareSms,
      canClick: true,
    ));
    firstRowList.add(ShareItem(
      BaseShareItemConstants.shareWeiBo,
      canClick: true,
    ));
    secondRowList.add(ShareItem(
      BaseShareItemConstants.shareQZone,
      canClick: false,
    ));
    secondRowList.add(ShareItem(
    ...
    ShareActionSheet actionSheet = ShareActionSheet(
      ...
      clickInterceptor: (int section, int index, ShareItem shareItem) {
        if (shareItem.canClick) {
          return false;
        } else {
          PhoenixToast.show("不可点击，拦截了", context);
          return true;
        }
      },
    );
